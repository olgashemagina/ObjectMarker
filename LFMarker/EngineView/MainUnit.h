...
private:	// User declarations
	...
	void __fastcall DrawEngine();
	void __fastcall DrawLayer0(TCanvas* cnv);
	void __fastcall DrawLayer1(TCanvas* cnv);
	void __fastcall DrawLayer2(TCanvas* cnv);
	void __fastcall DrawLayer3(TCanvas* cnv);
